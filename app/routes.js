...
// version BETA V5 start

router.post('/beta/v5/apply-2', function (req, res) {
  var relationship = req.body.relationship
...
router.get('/beta/v5/apply-4', function (req, res) {
  var benefit = req.query.benefit

  res.render('beta/v5/apply-4', { 'benefit': benefit })
})

router.get('/beta/v5/apply-5', function (req, res) {
  var benefit = req.query.benefit

  if (benefit === '' | 'None of the above') {
    res.redirect('el-no')
  } else {
    res.render('beta/v5/apply-5', { 'benefit': benefit })
  }
})


router.post('/beta/v5/apply-1', function (req, res) {
  var returningUser = req.body.returningUser
...
router.post('/beta/v5/apply-10', function (req, res) {
  var eligibilityNo = req.body.eligibilityNo
...
router.get('/beta/v5/apply-99', function (req, res) {
  var eligibilityChildren = req.query.eligibilityChildren

  if (eligibilityChildren === 'true') {
    res.redirect('/beta/v5/apply-99-child')
  } else {
    res.render('beta/v5/apply-99')
  }
})

router.get('/beta/v5/apply-add-info-taxi.html', function (req, res) {
  var childJourney = req.query.childJourney

  if (childJourney === 'true') {
    res.redirect('/beta/v5/apply-add-info-train-child.html')
  } else {
    res.render('beta/v5/apply-add-info-taxi.html')
  }
})

router.get('/beta/v5/returning.html', function (req, res) {
  var returningUser = req.query.returningUser

  if (returningUser === 'no') {
    res.redirect('/beta/v5/apply-1.html')
  } else {
    res.render('beta/v5/returning.html')
  }
})

// version BETA V6 start

router.post('/beta/v6/apply-2', function (req, res) {
  var relationship = req.body.relationship
...
router.get('/beta/v6/apply-4', function (req, res) {
  var benefit = req.query.benefit

  res.render('beta/v6/apply-4', { 'benefit': benefit })
})

router.get('/beta/v6/apply-5', function (req, res) {
  var benefit = req.query.benefit

  if (benefit === '' | 'None of the above') {
    res.redirect('el-no')
  } else {
    res.render('beta/v6/apply-5', { 'benefit': benefit })
  }
})


router.post('/beta/v6/apply-1', function (req, res) {
  var returningUser = req.body.returningUser
...
router.post('/beta/v6/apply-10', function (req, res) {
  var eligibilityNo = req.body.eligibilityNo
...
router.get('/beta/v6/apply-99', function (req, res) {
  var eligibilityChildren = req.query.eligibilityChildren

  if (eligibilityChildren === 'true') {
    res.redirect('/beta/v6/apply-99-child')
  } else {
    res.render('beta/v6/apply-99')
  }
})

router.get('/beta/v6/apply-add-info-taxi.html', function (req, res) {
  var childJourney = req.query.childJourney

  if (childJourney === 'true') {
    res.redirect('/beta/v6/apply-add-info-train-child.html')
  } else {
    res.render('beta/v6/apply-add-info-taxi.html')
  }
})

router.get('/beta/v6/returning.html', function (req, res) {
  var returningUser = req.query.returningUser

  if (returningUser === 'no') {
    res.redirect('/beta/v6/apply-1.html')
  } else {
    res.render('beta/v6/returning.html')
  }
})

var documentTypeEnum = {
  'VISIT_CONFIRMATION': {documentType: 'VISIT-CONFIRMATION', title: 'Add visit confirmation form', guidingText: 'Provide the stamped form as evidence of your visit.'},
  'working-tax-credit': {documentType: 'working-tax-credit', title: 'Working Tax credits or Child tax credit with disability documentation', guidingText: 'You must provide evidence of each page of your Working Tax credits or Child tax credit with disability documentation, upload one page at a time'},
  'pension-credit': {documentType: 'pension-credit', title: 'Pension credit documentation', guidingText: 'You must provide evidence of each page of your Pension Credit documentation, upload one page at a time'},
...
router.get('/ci/v1/upload', function (req, res) {
  res.render('ci/v1/apply-upload', {
